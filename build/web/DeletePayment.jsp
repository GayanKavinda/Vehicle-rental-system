...
%>
<h2 align="center"><font><strong>Payment Delete Portal</strong></font></h2><br>
<table id="table-delete" align="center" cellpadding="5" cellspacing="5" border="1">
<tr>
...
<td><a class="edit" href="DeleteData?pid=<%=resultSet.getString("pid") %>">Delete</a></td>
